...
import { familiaDeTexto } from "../cursos/alias.js";
 ...
 *
 * La familia sale de `alias_curso` y se resuelve con `familiaDeTexto`, el MISMO
...
export function familiaDe(aliases: readonly AliasCurso[], texto: string | null | undefined): string | null {
  return familiaDeTexto(aliases, texto)?.familia ?? null;
}
...
export function nombreDeProducto(
  ...
  return mejorAlias ? capitalizar(mejorAlias) : familia;
}
