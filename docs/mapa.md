...
| server | 66 | 707 | 73,191 | 43,442 |
| **total** | **98** | **1,052** | **119,191** | **57,411** |
...
| `scripts` | Los comandos de operación, dry-run por default. Ninguno es parte del proceso que corre en producción. | 32 | 5,204 | 0 | 0 | 32 |
