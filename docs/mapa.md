...
|---|---|--:|--:|--:|--:|--:|
| `notas` | La Libreta: páginas, espacios compartidos, autoguardado y el link público. | 52 | 6,006 | 15 | 5 | 1 |
...
| Módulo | De qué es responsable | Arch. | Líneas | Tests | Lo usan | Usa |
|---|---|--:|--:|--:|--:|--:|
| `routes` | La capa HTTP: valida con Zod, llama a un seam del dominio y serializa. No escribe SQL. | 61 | 10,178 | 11 | 3 | 48 |
