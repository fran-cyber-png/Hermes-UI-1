# CLAUDE.md — el archivo completo antes del recorte (9-ago-2026)

Este es `CLAUDE.md` tal como estaba en `36e7693`, **156.323 caracteres**, antes de
ADR 0045. Se conserva porque varios frentes no tienen ADR propio y su fundamento vivía
solo acá: WhatsApp (la costura y las llamadas de voz), las reacciones, «abrir un chat lo
marca leído», los ✓✓, los límites de media, el bot en la cola y los leads de formulario.

**No se edita.** Lo que sigue vivo se mantiene en `CLAUDE.md`; lo que se decida de nuevo
va a un ADR. Si un frente de acá gana su propio ADR, borrá su sección de este archivo.
